...
#JwtProvider: {
	...
	//	max_lifetime:
	//	  seconds: 86400
	max_lifetime?: durationpb.#Duration
...
#RemoteJwks: {
	...
	//	  cluster: jwt.www.googleapis.com|443
	//	  timeout: 1s
	http_uri?: v31.#HttpUri
	// Duration after which the cached JWKS should be expired. If not specified, default cache
	// duration is 10 minutes.
	cache_duration?: durationpb.#Duration
...
#JwksAsyncFetch: {
	...
	failed_refetch_duration?: durationpb.#Duration
}
...
#JwtProvider_NormalizePayload: {
	"@type": "type.googleapis.com/envoy.extensions.filters.http.jwt_authn.v3.JwtProvider_NormalizePayload"
