...
#HttpConnectionManager: {
	...
	add_user_agent?: wrapperspb.#BoolValue
	...
	max_request_headers_kb?: wrapperspb.#UInt32Value
	...
	stream_idle_timeout?: durationpb.#Duration
	// The amount of time that Envoy will wait for the entire request to be received.
	// The timer is activated when the request is initiated, and is disarmed when the last byte of the
	// request is sent upstream (i.e. all decoding filters have processed the request), OR when the
	// response is initiated. If not specified or set to 0, this timeout is disabled.
	request_timeout?: durationpb.#Duration
	...
	request_headers_timeout?: durationpb.#Duration
	...
	drain_timeout?: durationpb.#Duration
	...
	delayed_close_timeout?: durationpb.#Duration
	...
	use_remote_address?: wrapperspb.#BoolValue
	...
	generate_request_id?: wrapperspb.#BoolValue
	...
	// :ref:`header validation configuration <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.typed_header_validation_config>`
	// is present.]
	normalize_path?: wrapperspb.#BoolValue
	...
	stream_error_on_invalid_http_message?: wrapperspb.#BoolValue
	...
	add_proxy_protocol_connection_state?: wrapperspb.#BoolValue
}
...
#ResponseMapper: {
	...
	status_code?: wrapperspb.#UInt32Value
...
#HttpConnectionManager_Tracing: {
	...
	// Default: 256
	max_path_tag_length?: wrapperspb.#UInt32Value
	...
	spawn_upstream_span?: wrapperspb.#BoolValue
}
