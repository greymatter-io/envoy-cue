...
#FilterChainMatch: {
	...
	destination_port?: wrapperspb.#UInt32Value
	...
	// [#not-implemented-hide:]
	suffix_len?: wrapperspb.#UInt32Value
...
#FilterChain: {
	...
	use_proxy_proto?: wrapperspb.#BoolValue
	...
	transport_socket_connect_timeout?: durationpb.#Duration
...
#FilterChain_OnDemandConfiguration: {
	...
	rebuild_timeout?: durationpb.#Duration
}
