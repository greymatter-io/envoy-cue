...
#QuicKeepAliveSettings: {
	...
	initial_interval?: durationpb.#Duration
}
...
#QuicProtocolOptions: {
	...
	// if not specified.
	max_concurrent_streams?: wrapperspb.#UInt32Value
	...
	initial_stream_window_size?: wrapperspb.#UInt32Value
	...
	initial_connection_window_size?: wrapperspb.#UInt32Value
	...
	num_timeouts_to_trigger_port_migration?: wrapperspb.#UInt32Value
	...
	idle_network_timeout?: durationpb.#Duration
	...
	max_packet_length?: wrapperspb.#UInt64Value
}
...
#AlternateProtocolsCacheOptions: {
	...
	max_entries?: wrapperspb.#UInt32Value
...
#HttpProtocolOptions: {
	...
	// <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.drain_timeout>`.
	max_connection_duration?: durationpb.#Duration
	...
	max_headers_count?: wrapperspb.#UInt32Value
	...
	max_response_headers_kb?: wrapperspb.#UInt32Value
	// Total duration to keep alive an HTTP request/response stream. If the time limit is reached the stream will be
	// reset independent of any other timeouts. If not specified, this value is not set.
	max_stream_duration?: durationpb.#Duration
	...
	max_requests_per_connection?: wrapperspb.#UInt32Value
}
...
#Http1ProtocolOptions: {
	...
	allow_absolute_url?: wrapperspb.#BoolValue
	...
	override_stream_error_on_invalid_http_message?: wrapperspb.#BoolValue
	...
	// See issue #21245.
	use_balsa_parser?: wrapperspb.#BoolValue
...
#KeepaliveSettings: {
	...
	connection_idle_interval?: durationpb.#Duration
}
...
#Http2ProtocolOptions: {
	...
	// compression.
	hpack_table_size?: wrapperspb.#UInt32Value
	...
	max_outbound_frames?: wrapperspb.#UInt32Value
	// Limit the number of pending outbound downstream frames of types PING, SETTINGS and RST_STREAM,
	// preventing high memory utilization when receiving continuous stream of these frames. Exceeding
	// this limit triggers flood mitigation and connection is terminated. The
	// “http2.outbound_control_flood“ stat tracks the number of terminated connections due to flood
	// mitigation. The default limit is 1000.
	max_outbound_control_frames?: wrapperspb.#UInt32Value
	...
	max_consecutive_inbound_frames_with_empty_payload?: wrapperspb.#UInt32Value
	...
	max_inbound_priority_frames_per_stream?: wrapperspb.#UInt32Value
	...
	max_inbound_window_update_frames_per_data_frame_sent?: wrapperspb.#UInt32Value
	...
	use_oghttp2_codec?: wrapperspb.#BoolValue
}
