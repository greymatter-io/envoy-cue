...
#ApiConfigSource: {
	...
	refresh_delay?: durationpb.#Duration
...
#RateLimitSettings: {
	...
	max_tokens?: wrapperspb.#UInt32Value
	...
	fill_rate?: wrapperspb.#DoubleValue
}
...
#ConfigSource: {
	...
	initial_fetch_timeout?: durationpb.#Duration
