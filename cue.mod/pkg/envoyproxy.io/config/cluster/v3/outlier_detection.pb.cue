...
#OutlierDetection: {
	...
	base_ejection_time?: durationpb.#Duration
	...
	max_ejection_percent?: wrapperspb.#UInt32Value
	// The % chance that a host will be actually ejected when an outlier status
	// is detected through consecutive 5xx. This setting can be used to disable
	// ejection or to ramp it up slowly. Defaults to 100.
	enforcing_consecutive_5xx?: wrapperspb.#UInt32Value
	// The % chance that a host will be actually ejected when an outlier status
	// is detected through success rate statistics. This setting can be used to
	// disable ejection or to ramp it up slowly. Defaults to 100.
	enforcing_success_rate?: wrapperspb.#UInt32Value
	// The number of hosts in a cluster that must have enough request volume to
	// detect success rate outliers. If the number of hosts is less than this
	// setting, outlier detection via success rate statistics is not performed
	// for any host in the cluster. Defaults to 5.
	success_rate_minimum_hosts?: wrapperspb.#UInt32Value
	// The minimum number of total requests that must be collected in one
	// interval (as defined by the interval duration above) to include this host
	// in success rate based outlier detection. If the volume is lower than this
	// setting, outlier detection via success rate statistics is not performed
	// for that host. Defaults to 100.
	success_rate_request_volume?: wrapperspb.#UInt32Value
	...
	success_rate_stdev_factor?: wrapperspb.#UInt32Value
	// The number of consecutive gateway failures (502, 503, 504 status codes)
	// before a consecutive gateway failure ejection occurs. Defaults to 5.
	consecutive_gateway_failure?: wrapperspb.#UInt32Value
	// The % chance that a host will be actually ejected when an outlier status
	// is detected through consecutive gateway failures. This setting can be
	// used to disable ejection or to ramp it up slowly. Defaults to 0.
	enforcing_consecutive_gateway_failure?: wrapperspb.#UInt32Value
	...
	// is set to true.
	consecutive_local_origin_failure?: wrapperspb.#UInt32Value
	// The % chance that a host will be actually ejected when an outlier status
	...
	// :ref:`split_external_local_origin_errors<envoy_v3_api_field_config.cluster.v3.OutlierDetection.split_external_local_origin_errors>`
	// is set to true.
	enforcing_consecutive_local_origin_failure?: wrapperspb.#UInt32Value
	// The % chance that a host will be actually ejected when an outlier status
	...
	// :ref:`split_external_local_origin_errors<envoy_v3_api_field_config.cluster.v3.OutlierDetection.split_external_local_origin_errors>`
	// is set to true.
	enforcing_local_origin_success_rate?: wrapperspb.#UInt32Value
	// The failure percentage to use when determining failure percentage-based outlier detection. If
	// the failure percentage of a given host is greater than or equal to this value, it will be
	// ejected. Defaults to 85.
	failure_percentage_threshold?: wrapperspb.#UInt32Value
	...
	// invalid in v4.]
	enforcing_failure_percentage?: wrapperspb.#UInt32Value
	// The % chance that a host will be actually ejected when an outlier status is detected through
	// local-origin failure percentage statistics. This setting can be used to disable ejection or to
	// ramp it up slowly. Defaults to 0.
	enforcing_failure_percentage_local_origin?: wrapperspb.#UInt32Value
	// The minimum number of hosts in a cluster in order to perform failure percentage-based ejection.
	// If the total number of hosts in the cluster is less than this value, failure percentage-based
	// ejection will not be performed. Defaults to 5.
	failure_percentage_minimum_hosts?: wrapperspb.#UInt32Value
	// The minimum number of total requests that must be collected in one interval (as defined by the
	// interval duration above) to perform failure percentage-based ejection for this host. If the
	// volume is lower than this setting, failure percentage-based ejection will not be performed for
	// this host. Defaults to 50.
	failure_percentage_request_volume?: wrapperspb.#UInt32Value
	...
	max_ejection_time?: durationpb.#Duration
	...
	// Defaults to 0s.
	max_ejection_time_jitter?: durationpb.#Duration
	...
	// Defaults to true.
	successful_active_health_check_uneject_host?: wrapperspb.#BoolValue
	...
	// Defaults to false.
	always_eject_one_host?: wrapperspb.#BoolValue
}
