...
#Cluster: {
	...
	connect_timeout?: durationpb.#Duration
	// Soft limit on size of the cluster’s connections read and write buffers. If
	// unspecified, an implementation defined default is applied (1MiB).
	per_connection_buffer_limit_bytes?: wrapperspb.#UInt32Value
	...
	typed_extension_protocol_options?: [string]: anypb.#Any
	...
	dns_refresh_rate?: durationpb.#Duration
	...
	// and :ref:`LOGICAL_DNS<envoy_v3_api_enum_value_config.cluster.v3.Cluster.DiscoveryType.LOGICAL_DNS>`
	// this setting is ignored.
	dns_jitter?: durationpb.#Duration
	...
	wait_for_warm_on_init?: wrapperspb.#BoolValue
	...
	// :ref:`ORIGINAL_DST<envoy_v3_api_enum_value_config.cluster.v3.Cluster.DiscoveryType.ORIGINAL_DST>`
	// this setting is ignored.
	cleanup_interval?: durationpb.#Duration
...
#Cluster_SlowStartConfig: {
	...
	slow_start_window?: durationpb.#Duration
...
#Cluster_RingHashLbConfig: {
	...
	minimum_ring_size?: wrapperspb.#UInt64Value
	...
	maximum_ring_size?: wrapperspb.#UInt64Value
}
...
#Cluster_MaglevLbConfig: {
	...
	table_size?: wrapperspb.#UInt64Value
}
...
#Cluster_OriginalDstLbConfig: {
	...
	upstream_port_override?: wrapperspb.#UInt32Value
...
#Cluster_CommonLbConfig: {
	...
	update_merge_window?: durationpb.#Duration
...
#Cluster_PreconnectPolicy: {
	...
	per_upstream_preconnect_ratio?: wrapperspb.#DoubleValue
	...
	// upstream.
	predictive_preconnect_ratio?: wrapperspb.#DoubleValue
}
...
#Cluster_CommonLbConfig_ZoneAwareLbConfig: {
	...
	// * :ref:`runtime values <config_cluster_manager_cluster_runtime_zone_routing>`.
	// * :ref:`Zone aware routing support <arch_overview_load_balancing_zone_aware_routing>`.
	min_cluster_size?: wrapperspb.#UInt64Value
...
#Cluster_CommonLbConfig_ConsistentHashingLbConfig: {
	...
	hash_balance_factor?: wrapperspb.#UInt32Value
}
...
#UpstreamConnectionOptions_HappyEyeballsConfig: {
	...
	first_address_family_count?: wrapperspb.#UInt32Value
}
