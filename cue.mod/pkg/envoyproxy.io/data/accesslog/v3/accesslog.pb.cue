...
#AccessLogType: "NotSet" | "TcpUpstreamConnected" | "TcpPeriodic" | "TcpConnectionEnd" | "DownstreamStart" | "DownstreamPeriodic" | "DownstreamEnd" | "UpstreamPoolReady" | "UpstreamPeriodic" | "UpstreamEnd" | "DownstreamTunnelSuccessfullyEstablished" | "UdpTunnelUpstreamConnected" | "UdpPeriodic" | "UdpSessionEnd"
...
AccessLogType_DownstreamTunnelSuccessfullyEstablished: "DownstreamTunnelSuccessfullyEstablished"
AccessLogType_UdpTunnelUpstreamConnected:              "UdpTunnelUpstreamConnected"
AccessLogType_UdpPeriodic:                             "UdpPeriodic"
AccessLogType_UdpSessionEnd:                           "UdpSessionEnd"
...
#AccessLogCommon: {
	...
	time_to_last_rx_byte?: durationpb.#Duration
	// Interval between the first downstream byte received and the first upstream byte sent. There may
	// by considerable delta between “time_to_last_rx_byte“ and this value due to filters.
	// Additionally, the same caveats apply as documented in “time_to_last_downstream_tx_byte“ about
	// not accounting for kernel socket buffer time, etc.
	time_to_first_upstream_tx_byte?: durationpb.#Duration
	// Interval between the first downstream byte received and the last upstream byte sent. There may
	// by considerable delta between “time_to_last_rx_byte“ and this value due to filters.
	// Additionally, the same caveats apply as documented in “time_to_last_downstream_tx_byte“ about
	// not accounting for kernel socket buffer time, etc.
	time_to_last_upstream_tx_byte?: durationpb.#Duration
	// Interval between the first downstream byte received and the first upstream
	// byte received (i.e. time it takes to start receiving a response).
	time_to_first_upstream_rx_byte?: durationpb.#Duration
	// Interval between the first downstream byte received and the last upstream
	// byte received (i.e. time it takes to receive a complete response).
	time_to_last_upstream_rx_byte?: durationpb.#Duration
	// Interval between the first downstream byte received and the first downstream byte sent.
	// There may be a considerable delta between the “time_to_first_upstream_rx_byte“ and this field
	// due to filters. Additionally, the same caveats apply as documented in
	// “time_to_last_downstream_tx_byte“ about not accounting for kernel socket buffer time, etc.
	time_to_first_downstream_tx_byte?: durationpb.#Duration
	...
	time_to_last_downstream_tx_byte?: durationpb.#Duration
	...
	// “google.protobuf.Any“.
	filter_state_objects?: [string]: anypb.#Any
...
#TLSProperties: {
	...
	tls_cipher_suite?: wrapperspb.#UInt32Value
...
#HTTPResponseProperties: {
	...
	response_code?: wrapperspb.#UInt32Value
