...
#ServerInfo: {
	...
	uptime_current_epoch?: durationpb.#Duration
	// Uptime since the start of the first epoch.
	uptime_all_epochs?: durationpb.#Duration
	// Hot restart version.
...
#CommandLineOptions: {
	...
	file_flush_interval?: durationpb.#Duration
	// See :option:`--drain-time-s` for details.
	drain_time?: durationpb.#Duration
	// See :option:`--parent-shutdown-time-s` for details.
	parent_shutdown_time?: durationpb.#Duration
