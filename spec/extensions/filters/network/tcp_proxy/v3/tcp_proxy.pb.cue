...
import (
	...
	v33 "envoyproxy.io/envoy-cue/spec/extensions/filters/network/http_connection_manager/v3"
)
...
UpstreamConnectMode_IMMEDIATE:                   "IMMEDIATE"
UpstreamConnectMode_ON_DOWNSTREAM_DATA:          "ON_DOWNSTREAM_DATA"
UpstreamConnectMode_ON_DOWNSTREAM_TLS_HANDSHAKE: "ON_DOWNSTREAM_TLS_HANDSHAKE"
...
#ProxyProtocolTlvMergePolicy: "ADD_IF_ABSENT" | "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD" | "APPEND_IF_EXISTS_OR_ADD"

ProxyProtocolTlvMergePolicy_ADD_IF_ABSENT:                      "ADD_IF_ABSENT"
ProxyProtocolTlvMergePolicy_OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD: "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD"
ProxyProtocolTlvMergePolicy_APPEND_IF_EXISTS_OR_ADD:            "APPEND_IF_EXISTS_OR_ADD"
...
#TcpProxy: {
	...
	// is added.
	max_downstream_connection_duration_jitter_percentage?: v32.#Percent
	...
	proxy_protocol_tlvs?: [...v3.#TlvEntry]
	// Specifies how TLVs in “proxy_protocol_tlvs“ are merged with existing PROXY protocol state
	...
	proxy_protocol_tlv_merge_policy?: #ProxyProtocolTlvMergePolicy
...
#TcpProxy_TunnelingConfig: {
	...
	request_id_extension?: v33.#RequestIDExtension
