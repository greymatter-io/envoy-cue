...
#EndpointMetadataInput: {
	...
	path?: [...#EndpointMetadataInput_PathSegment]
}
...
#LocalityMetadataInput: {
	...
	filter?: string
	// The path to retrieve the Value from the Struct.
	path?: [...#LocalityMetadataInput_PathSegment]
}
...
#EndpointMetadataInput_PathSegment: {
	"@type": "type.googleapis.com/envoy.extensions.matching.common_inputs.transport_socket.v3.EndpointMetadataInput_PathSegment"
...
#LocalityMetadataInput_PathSegment: {
	"@type": "type.googleapis.com/envoy.extensions.matching.common_inputs.transport_socket.v3.LocalityMetadataInput_PathSegment"
	// If specified, use the key to retrieve the value in a Struct.
	key?: string
}
